...
export const danhSachNhanVien: NhanVien[] = [
  ...
  },
  {
    id: "ACC001",
    ten: "Hoàng Minh Đức",
    namSinh: new Date("1990-12-12"),
    gioiTinh: "Nam",
    ngayBatDau: new Date("2022-05-20"),
    maViTri: "ACC",
    tenViTri: "Kế toán",
  ...
  },
  {
    id: "IT004",
    ten: "Vũ Thanh Tùng",
    namSinh: new Date("1993-04-25"),
    gioiTinh: "Nam",
    ngayBatDau: new Date("2022-01-01"),
    maViTri: "IT",
    tenViTri: "Quản lý dự án IT",
  ...
  },
  {
    id: "IT005",
    ten: "Lê Thúy An",
    namSinh: new Date("2003-10-05"),
    gioiTinh: "Nữ",
    ngayBatDau: new Date("2024-05-01"),
    maViTri: "IT",
    tenViTri: "Kiểm thử phần mềm",
  ...
  },
  {
    id: "HR002",
    ten: "Ngô Quang Huy",
    namSinh: new Date("1996-06-06"),
    gioiTinh: "Nam",
    ngayBatDau: new Date("2023-09-10"),
    maViTri: "HR",
    tenViTri: "Tuyển dụng",
    chucVu: "Chuyên viên",
    maPhong: "PNS",
  ...
  {
    id: "ADMIN001",
    ten: "Nguyễn Văn Chiến",
    namSinh: new Date("1985-08-08"),
    gioiTinh: "Nam",
    ngayBatDau: new Date("2021-03-15"),
    maViTri: "ADMIN",
    tenViTri: "Hành chính tổng hợp",
    chucVu: "Trưởng phòng",
    maPhong: "PQT",
    tenPhong: "Phòng Quản trị",
    luongCoBan: 16000000,
  },
  {
    id: "ADMIN002",
    ten: "Trương Mỹ Linh",
    namSinh: new Date("2002-12-24"),
    gioiTinh: "Nữ",
    ngayBatDau: new Date("2024-02-29"),
    maViTri: "ADMIN",
    tenViTri: "Văn thư",
    chucVu: "Nhân viên",
    maPhong: "PQT",
  ...
  },
  {
    id: "SALE003",
    ten: "Bùi Thanh Hải",
    namSinh: new Date("1999-04-10"),
    gioiTinh: "Nam",
    ngayBatDau: new Date("2024-06-01"),
    maViTri: "SALE",
    tenViTri: "Chăm sóc khách hàng",
    chucVu: "Chuyên viên",
    maPhong: "PKD",
    tenPhong: "Phòng Kinh doanh",
    luongCoBan: 10000000,
  },
  {
    id: "IT006",
    ten: "Đỗ Gia Hân",
    namSinh: new Date("2000-09-30"),
    gioiTinh: "Nữ",
    ngayBatDau: new Date("2023-03-03"),
    maViTri: "IT",
    tenViTri: "Thiết kế UI/UX",
    chucVu: "Chuyên viên",
    maPhong: "PKT",
    tenPhong: "Phòng Kỹ thuật",
    luongCoBan: 13000000,
  },
  {
    id: "ACC003",
    ten: "Nguyễn Thị Lan",
    namSinh: new Date("1991-05-05"),
    gioiTinh: "Nữ",
    ngayBatDau: new Date("2022-10-10"),
    maViTri: "ACC",
    tenViTri: "Thủ quỹ",
    chucVu: "Nhân viên",
    maPhong: "PKT-TC",
  ...
  },
  {
    id: "HR003",
    ten: "Vương Đình An",
    namSinh: new Date("1988-02-14"),
    gioiTinh: "Nam",
    ngayBatDau: new Date("2020-01-01"),
    maViTri: "HR",
    tenViTri: "Đào tạo và phát triển",
    chucVu: "Trưởng phòng",
    maPhong: "PNS",
    tenPhong: "Phòng Nhân sự",
    luongCoBan: 20000000,
